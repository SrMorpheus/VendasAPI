        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeBloco = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TiposDePagamentos = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelefoneClientes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TelefoneClientes_Clientes_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Logins_Usuarios_UsuarioLoginId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_telefoneUsuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_telefoneUsuarios_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EntradaDeProdutos_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Preco = table.Column<double>(type: "double", nullable: false),
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    TipoDeHistorico = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Observcao = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vendass", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vendass_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendass_Pagamentos_PagamentoId",
                        column: x => x.PagamentoId,
                        principalTable: "Pagamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendass_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendass_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntradaDeProdutos_UsuarioId",
                table: "EntradaDeProdutos",
                column: "UsuarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ruas_BlocoId",
                table: "Ruas",
                column: "BlocoId");

            migrationBuilder.CreateIndex(
                name: "IX_TelefoneClientes_ClienteId",
                table: "TelefoneClientes",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_telefoneUsuarios_UsuarioId",
                table: "telefoneUsuarios",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendass_ClienteId",
                table: "Vendass",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendass_PagamentoId",
                table: "Vendass",
                column: "PagamentoId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendass_ProdutoId",
                table: "Vendass",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendass_UsuarioId",
                table: "Vendass",
                column: "UsuarioId");
        }
